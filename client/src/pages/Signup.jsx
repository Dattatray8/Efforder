...
function Signup() {
  ...
  const [userNameErrorMessage, setUserNameErrorMessge] = useState("");
  ...
  const { getCurrentUser } = UserContext(userDataContext);
  const handleSubmit = async (e) => {
    e.preventDefault();

    if (userName == "") {
      setUserNameErrorMessge("Username is required");
    }
    if (email == "") {
    ...
    try {
      ...
      if (error.response.status == 409) {
        setUserNameErrorMessge(error.response.data.message);
      } else if (userName == "") {
        setUserNameErrorMessge("Username is required");
      } else {
        setUserNameErrorMessge("");
      }
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
            ...
            <button
              ...
              className="w-full flex cursor-pointer items-center justify-center space-x-3 py-3 px-4 border border-gray-300 rounded-xl hover:bg-gray-50 transition-colors duration-200 mb-6"
            >
            ...
            <form>
              <div className="space-y-2">
                ...
                <button
                  ...
                  className="w-full bg-blue-600 text-white py-3 cursor-pointer px-4 rounded-xl hover:bg-blue-700 focus:ring-4 focus:ring-blue-200 font-medium transition-all duration-200 mt-6"
                >
                  Create Account
                </button>
